...
def CNN_Model():
    ...
    model.save('Saved_Models/CNN_CIFAR10_SavedModel.h5')
    np.save('Saved_Models/CNN_CIFAR10_SavedTrainHistory.npy',result.history)


#Check if a model is already created
#Define if you want to train the model again or not
if os.path.exists('Saved_Models/CNN_CIFAR10_SavedModel.h5')==False:
    CNN_Model()
elif os.path.exists('Saved_Models/CNN_CIFAR10_SavedModel.h5')==True:
...
ModelHistory =np.load('Saved_Models/CNN_CIFAR10_SavedTrainHistory.npy',allow_pickle='TRUE').item()
...
with tf.device('/CPU:0'):
  new_model = tf.keras.models.load_model('Saved_Models/CNN_CIFAR10_SavedModel.h5')
